def generate_testcases():
    ...
    print(81, n, *arr81, k81, expected81)

    # 82: All ones
    arr82 = [1] * n
    k82 = n
    expected82 = 1  # only full array sums to n
    print(82, n, *arr82, k82, expected82)
    ...
    for num in arr83:
        ...
        freq[prefix_sum] += 1
    expected83 = count
    print(83, n, *arr83, k83, expected83)

    # 84: All 1000s
    arr84 = [1000] * n
    k84 = 1000
    expected84 = n  # each single element counts
    print(84, n, *arr84, k84, expected84)
    ...
    print(85, n, *arr85, k85, expected85)
    ...
    for num in arr86:
        ...
        freq[prefix_sum] += 1
    expected86 = count
    print(86, n, *arr86, k86, expected86)
